...
public class FindingActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        Button findingId = findViewById(R.id.finding_id_button);
        Button findingPassword= findViewById(R.id.finding_password_button);

        findingId.setOnClickListener(this);
        findingPassword.setOnClickListener(this);
